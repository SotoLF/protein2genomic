...
void print_usage(const char* program_name) {
    std::cout << "Protein2Genomic - High-Performance Domain Mapping Tool\n"
              ...
              << "Options:\n"
              << "  --gtf FILE         GTF annotation file (supports GENCODE and Ensembl formats)\n"
              ...
              << "GTF Format Support:\n"
              << "  Supports both GENCODE and Ensembl GTF formats\n"
              << "  Automatically handles protein ID versioning (e.g., ENSP00000306245.4 → ENSP00000306245)\n"
              << "  Compatible with BED files using versioned or unversioned protein IDs\n\n"
              << "Mapping Modes:\n"
              ...
              << "Examples:\n"
              << "  # Build index from GENCODE GTF (one-time setup)\n"
              << "  " << program_name << " --gtf gencode.v49.basic.annotation.gtf --build-index --index gencode.idx\n\n"
              << "  # Build index from Ensembl GTF (one-time setup)\n"
              << "  " << program_name << " --gtf Homo_sapiens.GRCh38.115.gtf --build-index --index ensembl.idx\n\n"
